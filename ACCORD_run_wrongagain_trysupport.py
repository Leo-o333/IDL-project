...
# dataset=dev.dataset
# from auton_survival_master.dsm import datasets

# dataset = datasets.load_dataset('SUPPORT')
...
vl_size_0 = int(n_0*0.20)
te_size_0 = int(n_0*0.30)
# tr_size_0 = int(n_0*0.70)
# vl_size_0 = int(n_0*0.10)
# te_size_0 = int(n_0*0.20)


x_train_control_0, x_test_control_0, x_val_control_0 = x_control_0.iloc[:tr_size_0], x_control_0.iloc[-te_size_0:], x_control_0.iloc[tr_size_0:tr_size_0+vl_size_0]
t_train_control_0, t_test_control_0, t_val_control_0 = t_control_0.iloc[:tr_size_0], t_control_0.iloc[-te_size_0:], t_control_0.iloc[tr_size_0:tr_size_0+vl_size_0]
e_train_control_0, e_test_control_0, e_val_control_0 = e_control_0.iloc[:tr_size_0], e_control_0.iloc[-te_size_0:], e_control_0.iloc[tr_size_0:tr_size_0+vl_size_0]

tr_size_1 = int(n_1*0.50)
vl_size_1 = int(n_1*0.20)
te_size_1 = int(n_1*0.30)
# tr_size_1 = int(n_0*0.70)
# vl_size_1 = int(n_0*0.10)
# te_size_1 = int(n_0*0.20)

x_train_control_1, x_test_control_1, x_val_control_1 = x_control_1.iloc[:tr_size_1], x_control_1.iloc[-te_size_1:], x_control_1.iloc[tr_size_1:tr_size_1+vl_size_1]
t_train_control_1, t_test_control_1, t_val_control_1 = t_control_1.iloc[:tr_size_1], t_control_1.iloc[-te_size_1:], t_control_1.iloc[tr_size_1:tr_size_1+vl_size_1]
e_train_control_1, e_test_control_1, e_val_control_1 = e_control_1.iloc[:tr_size_1], e_control_1.iloc[-te_size_1:], e_control_1.iloc[tr_size_1:tr_size_1+vl_size_1]
...
x_train_treatment_0, x_test_treatment_0, x_val_treatment_0 = x_treatment_0.iloc[:tr_size_0], x_treatment_0.iloc[-te_size_0:], x_treatment_0.iloc[tr_size_0:tr_size_0+vl_size_0]
t_train_treatment_0, t_test_treatment_0, t_val_treatment_0 = t_treatment_0.iloc[:tr_size_0], t_treatment_0.iloc[-te_size_0:], t_treatment_0.iloc[tr_size_0:tr_size_0+vl_size_0]
e_train_treatment_0, e_test_treatment_0, e_val_treatment_0 = e_treatment_0.iloc[:tr_size_0], e_treatment_0.iloc[-te_size_0:], e_treatment_0.iloc[tr_size_0:tr_size_0+vl_size_0]
...
x_train_treatment_1, x_test_treatment_1, x_val_treatment_1 = x_treatment_1.iloc[:tr_size_1], x_treatment_1.iloc[-te_size_1:], x_treatment_1.iloc[tr_size_1:tr_size_1+vl_size_1]
t_train_treatment_1, t_test_treatment_1, t_val_treatment_1 = t_treatment_1.iloc[:tr_size_1], t_treatment_1.iloc[-te_size_1:], t_treatment_1.iloc[tr_size_1:tr_size_1+vl_size_1]
e_train_treatment_1, e_test_treatment_1, e_val_treatment_1 = e_treatment_1.iloc[:tr_size_1], e_treatment_1.iloc[-te_size_1:], e_treatment_1.iloc[tr_size_1:tr_size_1+vl_size_1]
...
#     ### using the val data to predict the survival function
    # print(param['k'],param['distribution'],param['layers'],param['learning_rate'],param['elbo'])
...
param_grid = {'k':[3,4,6], 'layers':[[],[50],[50,50]], 'gamma':[10,20],\
